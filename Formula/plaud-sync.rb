class PlaudSync < Formula
  ...
  url "https://github.com/cchiles/plaud-sync/releases/download/v0.2.0/plaud-sync-darwin-arm64.tar.gz"
  sha256 "3795b43c4991ba201d5a7a893a9c511fed1e42bfebfd2924c1a9fc3e1685446f"
